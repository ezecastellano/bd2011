...
public class RecoveryAnalyzerFormController
{
	...
	private void ClearTableLog()
	{
		...
		//Ademas de remover las columnas, hay que llamar a este metodo (aparentemente, bug de Java: http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4283734)
	...
	public void EditLogRecord(int recordNumber) throws GUIException
    {
		...
		if(logRecord != null)
		{
			...
			formTableModel.setValueAt(logRecord.toString(), 
				recordNumber,
				1);	//La columna 1 es donde esta el contenido del registro
		}
	}
	//[end]
	...
	private void AddLogRecordToForm(RecoveryLogRecord logRecord)
	{
    	...
    	Object[] newRow = new Object[formTableModel.getColumnCount() + 1];	//No se por que pero necesita el +1
